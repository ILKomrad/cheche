...
/***/ "./src/app/meetings/auth/auth.component.scss":
/*!***************************************************!*\
  !*** ./src/app/meetings/auth/auth.component.scss ***!
  \***************************************************/
/*! no static exports found */
...
/***/ "./src/app/meetings/auth/auth.component.ts":
/*!*************************************************!*\
  !*** ./src/app/meetings/auth/auth.component.ts ***!
  \*************************************************/
...
var AuthComponent = /** @class */ (function () {
    function AuthComponent(fb, authService) {
        this.fb = fb;
    ...
    AuthComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-auth',
            template: __webpack_require__(/*! ./auth.component.html */ "./src/app/meetings/auth/auth.component.html"),
            styles: [__webpack_require__(/*! ./auth.component.scss */ "./src/app/meetings/auth/auth.component.scss")]
        }),
...
/***/ "./src/app/meetings/meeting-generator/meeting-generator.component.html":
/*!*****************************************************************************!*\
  !*** ./src/app/meetings/meeting-generator/meeting-generator.component.html ***!
  \*****************************************************************************/
/*! no static exports found */
...
module.exports = "<form *ngIf=\"types.length\" [formGroup]=\"meetingForm\" class=\"form\" (submit)=\"onSubmit()\">\n    <h5 class=\"form__title\">create a meeting</h5>\n    <div class=\"form__box\">\n        <p>Select type:</p>\n        <div class=\"form__box form-checkboxes\">\n          <label class=\"form-checkboxes__label\" *ngFor=\"let _type of types\">\n              <input type=\"radio\" formControlName=\"type\" [value]=\"_type.alias\">\n              <span class=\"form-checkboxes__box\"></span>\n              {{_type.label}}\n          </label>\n        </div>\n    </div>\n    <p class=\"form__box\">\n        <button class=\"btn form__submit\">create</button>\n    </p>\n</form>"

/***/ }),

/***/ "./src/app/meetings/meeting-generator/meeting-generator.component.scss":
/*!*****************************************************************************!*\
  !*** ./src/app/meetings/meeting-generator/meeting-generator.component.scss ***!
  \*****************************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL21lZXRpbmdzL21lZXRpbmctZ2VuZXJhdG9yL21lZXRpbmctZ2VuZXJhdG9yLmNvbXBvbmVudC5zY3NzIn0= */"

/***/ }),

/***/ "./src/app/meetings/meeting-generator/meeting-generator.component.ts":
/*!***************************************************************************!*\
  !*** ./src/app/meetings/meeting-generator/meeting-generator.component.ts ***!
  \***************************************************************************/
/*! exports provided: MeetingGeneratorComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MeetingGeneratorComponent", function() { return MeetingGeneratorComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
...
var MeetingGeneratorComponent = /** @class */ (function () {
    function MeetingGeneratorComponent(fb) {
        this.fb = fb;
    ...
    MeetingGeneratorComponent.prototype.ngOnInit = function () {
        var _this = this;
        var types = this.types.map(function (c) { return _this.fb.control(false); });
        this.meetingForm = this.fb.group({
            name: '',
            type: this.types[0].alias
        });
    };
    MeetingGeneratorComponent.prototype.onSubmit = function () {
        var type = this.meetingForm.get('type').value;
        this.create.emit(type);
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
    ], MeetingGeneratorComponent.prototype, "create", void 0);
    MeetingGeneratorComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-meeting-generator',
            template: __webpack_require__(/*! ./meeting-generator.component.html */ "./src/app/meetings/meeting-generator/meeting-generator.component.html"),
            styles: [__webpack_require__(/*! ./meeting-generator.component.scss */ "./src/app/meetings/meeting-generator/meeting-generator.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"]])
    ], MeetingGeneratorComponent);
    return MeetingGeneratorComponent;
}());
...
/***/ "./src/app/meetings/meeting-list/meeting-list.component.scss":
/*!*******************************************************************!*\
  !*** ./src/app/meetings/meeting-list/meeting-list.component.scss ***!
  \*******************************************************************/
/*! no static exports found */
...
var MeetingListComponent = /** @class */ (function () {
    function MeetingListComponent() {
        this.selectGame = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    MeetingListComponent.prototype.ngOnInit = function () {
    };
    MeetingListComponent.prototype.select = function (id) {
        this.selectGame.emit(id);
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
    ], MeetingListComponent.prototype, "meetings", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
    ], MeetingListComponent.prototype, "userId", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
    ], MeetingListComponent.prototype, "selectGame", void 0);
    MeetingListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-meeting-list',
            template: __webpack_require__(/*! ./meeting-list.component.html */ "./src/app/meetings/meeting-list/meeting-list.component.html"),
            styles: [__webpack_require__(/*! ./meeting-list.component.scss */ "./src/app/meetings/meeting-list/meeting-list.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])
...
/***/ "./src/app/meetings/meeting.pipe.ts":
/*!******************************************!*\
  !*** ./src/app/meetings/meeting.pipe.ts ***!
  \******************************************/
/*! exports provided: MeetingsPipe */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MeetingsPipe", function() { return MeetingsPipe; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");


var MeetingsPipe = /** @class */ (function () {
    function MeetingsPipe() {
    }
    MeetingsPipe.prototype.transform = function (meetings, userId) {
        if (userId) {
    ...
    MeetingsPipe = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/* harmony import */ var _services_meetings_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../services/meetings.service */ "./src/app/services/meetings.service.ts");
...
var MeetingsComponent = /** @class */ (function () {
    function MeetingsComponent(authService, dataService, meetingsService, router) {
        this.authService = authService;
    ...
    MeetingsComponent.prototype.ngOnInit = function () {
        ...
        this.authService.isLoggedIn.subscribe(function (token) {
            ...
            _this.currentMeetingId = _this.authService.getCurrentMeetingId();
            _this.authState = _this.authService.getState();
        });
    ...
    MeetingsComponent.prototype.leaveMeeting = function () {
    ...
    MeetingsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            template: __webpack_require__(/*! ./meetings.component.html */ "./src/app/meetings/meetings.component.html"),
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"],
            ...
            _services_meetings_service__WEBPACK_IMPORTED_MODULE_5__["MeetingsService"],
...
/* harmony import */ var _meetings_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./meetings.component */ "./src/app/meetings/meetings.component.ts");
/* harmony import */ var _auth_auth_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./auth/auth.component */ "./src/app/meetings/auth/auth.component.ts");
